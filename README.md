...
I work across fintech operations, financial reconciliations, SQL, Python, BI, cloud data workflows, data validation, local warehouse foundations, and automation. My current portfolio is organized around production-minded data systems, including graph-based auditability with Cypher/Neo4j and a longer-term path toward data platforms, analytics engineering, and AI-enabled operations.

## Current Focus

- Financial reconciliation and auditability
- ETL/ELT and data validation workflows
- DuckDB / local warehouse foundations
...
| --- | --- | --- | --- |
| Lexian Transaction Engine | Released / v1.1.0 | Synthetic fintech transaction processing, observability, DuckDB warehouse foundations, SQL analytics | [Repository](https://github.com/arza1uz/lexian-transaction-engine) |
...
| SQL & Warehousing | SQL analysis, DuckDB foundations, data modeling, warehouse design |
